defmodule OkrlyWeb.Router do
  use OkrlyWeb, :router

  import OkrlyWeb.UserAuth

  pipeline :browser do
    plug :accepts, ["html"]
    plug :fetch_session
    plug :fetch_live_flash
    plug :put_root_layout, html: {OkrlyWeb.Layouts, :root}
  ...
  if Application.compile_env(:okrly, :dev_routes) do
    ...
    scope "/dev" do
      ...
      live_dashboard "/dashboard", metrics: OkrlyWeb.Telemetry
  ...
  scope "/", OkrlyWeb do
    ...
    live_session :redirect_if_user_is_authenticated,
      on_mount: [{OkrlyWeb.UserAuth, :redirect_if_user_is_authenticated}] do
  ...
  scope "/", OkrlyWeb do
    ...
    live_session :current_user,
      on_mount: [{OkrlyWeb.UserAuth, :mount_current_user}] do
